...
const ADAPTERS = [
  { rel: "harness/cursor/adapter", pkgPrefix: "ovrsr-fpp-adapter-cursor" },
  { rel: "harness/claude-code/adapter", pkgPrefix: "ovrsr-fpp-adapter-claude-code" },
  { rel: "harness/codex/adapter", pkgPrefix: "ovrsr-fpp-adapter-codex" },
] as const;
