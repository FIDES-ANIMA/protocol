...
1. **Classifies** the call against a risk taxonomy (`harness/openclaw/plugin/src/risk-classifier.ts`). Examples:
...
2. **Decides** via `resolveDisposition` (`harness/openclaw/plugin/src/disposition-engine.ts`):
