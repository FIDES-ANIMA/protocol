...
**Related:** `docs/dev-review.md` §3.2; `harness/shared/prompt/adoption/MEMORY-ENTRY.md`; `docs/REVOCATION.md`
...
- `harnessId` — profile/harness scope (see `harness/shared/harness-capabilities.json`)
...
Cross-links: Plan 11 harness capability matrix (`harness/shared/harness-capabilities.json`); `EVIDENCE_SEMANTICS.md` §7; examples `examples/graded-adoption-claims.json`.
