...
export function findWorkspacePackageDir(
  ...
  const direct = [
    join(repoRoot, "harness", "openclaw", "plugin"),
    join(repoRoot, "harness", "openclaw", "plugin-trust"),
    join(repoRoot, "harness", "cursor", "adapter"),
    join(repoRoot, "harness", "claude-code", "adapter"),
    join(repoRoot, "harness", "codex", "adapter"),
  ];
...
function printUsage(): void {
  ...
  --package   Consumer path relative to repo root (harness/openclaw/plugin, harness/cursor/adapter, …)
